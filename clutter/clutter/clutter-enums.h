...
typedef enum
{
  CLUTTER_INPUT_ACTION_SUBMIT,
  CLUTTER_INPUT_ACTION_BACKSPACE,
  CLUTTER_INPUT_ACTION_DELETE,
  CLUTTER_INPUT_ACTION_LAST,
} ClutterInputAction;

typedef enum
{
  CLUTTER_INPUT_ACTION_FLAG_SUBMIT = 1 << CLUTTER_INPUT_ACTION_SUBMIT,
  CLUTTER_INPUT_ACTION_FLAG_BACKSPACE = 1 << CLUTTER_INPUT_ACTION_BACKSPACE,
  CLUTTER_INPUT_ACTION_FLAG_DELETE = 1 << CLUTTER_INPUT_ACTION_DELETE,
  CLUTTER_INPUT_ACTION_FLAG_ALL = (1 << CLUTTER_INPUT_ACTION_LAST) - 1,
} ClutterInputActionFlags;
