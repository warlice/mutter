                                                        ...
                                                        float                    view_scale)
{
  ...
  if (meta_cursor_sprite_get_viewport_dst_size (cursor_sprite,
                                                ...
                                                &dst_height))
    {
      ...
      scale_x = dst_width / texture_width * view_scale;
      scale_y = dst_height / texture_height * view_scale;
  ...
  else if (src_rect)
    {
      ...
      scale_x = src_rect->size.width / texture_width * view_scale;
      scale_y = src_rect->size.height / texture_height * view_scale;
