...
ClutterColorState * meta_color_device_get_output_state (MetaColorDevice *color_device);

ClutterColorState * meta_color_device_get_view_state (MetaColorDevice *color_device);
